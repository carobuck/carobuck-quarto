...
Like any good party, we'll give some context for why we're doing this, then we'll cover the who, where, when, why, what and how of the party. 
...
If you were thinking COVID-19, then we are thinking the same thing. Data have always had (and still currently do have) a large impact in our lives, but the various impacts over time have not always been visible. Thanks to a global pandemic, data suddenlyt moved to the forefront and had a very visceral, very real, very obvious impact in our lives. dictated what we should/shouldn't do, who we could see, where we could go. understanding numbers and charts suddenly became crucial to our daily lives and a lot of new jargon was thrown into the vernacular- e.g. "flatten the curve" "mask up" etc. 
:::
:::{.div}
...
***
So what are data? Spoiler- all of those things! And so much more! Like in improv, this is a "yes, and" situation. meaning you take what your partner offers, and add something to the story, you may shape and refine and take in a new direction, but you meet the person where they're coming from/currently at

In addition to the above, data are:

* Creative! so much more than black/white (lots gray in between). data not always "hard n fast" or "right"
* Scientific, while very creative, it can also be rigorous way to study world around us, to collect info (that's basically what individual data bits are!)
...
:::
::: {.div}
![](imgs/rconf_preso_article/Who_Slide_3.png){fig-alt="Handwritten arrow with Novice on left, Expert on right. Arrow with blue asterisk points closer to novice. Sencond arrow points closer to expert"}
![](imgs/rconf_preso_article/Who_Slide_4.png){fig-alt="Several handwritten, swirling arrows from Novice on left to Expert on right."}
:::
:::
