...
![](imgs/rconf_preso/Title.png){fig-alt="Title slide that says 'the benefits of talking to the non-datas'"}
...
![](imgs/rconf_preso/Armchair.png){fig-alt="A hand-drawn navy and gold arm chair on a white background with confetti in the corners."}
