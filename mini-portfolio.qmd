...
[![[Quarto for Data Validation & Collaboration]{.bold}](posts/imgs/ported_imgs/cia-portrait.png){fig-alt="data portraits, one for each member of my team. Each portrait is colorful rectangle with abstract shapes/doodles"}](https://carobuck.com/mini-portfolio.html#quarto-for-data-validation-collaboration)

[![[Manneken Pis: Oddball Data Visualization]{.bold}](posts/imgs/ported_imgs/cia-portrait.png){fig-alt="data portraits, one for each member of my team. Each portrait is colorful rectangle with abstract shapes/doodles"}](https://carobuck.com/mini-portfolio.html#manneken-pis-oddball-data-visualization)
