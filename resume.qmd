...
*R* | *Python* | *Quarto* | *Flask* | *GCP* | *JS* </br></br>
I’m a curious and creative human, with a passion for data of all sorts. I love wrangling unconventional data or using a visualization to foster understanding and promote data literacy. I’m a pro at building and using APIs, write some mean documentation, and am learning frontend.
...
In my free time, you’ll find me swimming, sailing, swing dancing, or leading a tour around downtown Boston.
</br>
...
*Seattle Pacific University* | 2014 - 2018
...
### Experience
:::
#### Data Science Lead (promoted from Sr Data Scientist) | Jan 2022-May 2024
...
* Incorporate a variety of data sources (census, geospatial, AI-generated, etc.) to address client needs and questions
...
* Model audience segmentation to drive insights, inform strategic direction and inspire creative campaigns
