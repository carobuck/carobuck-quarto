...
[cbuck717@gmail.com](mailto:cbuck717@gmail.com) </br>
*R* | *Python* | *Quarto* | *Flask* | *GCP* </br></br>
...
* Tools include: R (tidyverse, tidymodels), Python (Pandas, CLIP+VQGAN, Flask, NLTK, spaCy), SQL, GPT-3, Google Cloud Platform (Firebase), git, Quarto
