...
:::{.div .portfolio}
[![[Bruna Tavares: Colorfeel]{.bold}](posts/imgs/portfolio/colorfeel.png){fig-alt="App logo that says Colorfeel by Bruna Tavares. A pink, circular, eye-inspired graphic is above the text."}](https://www.colorfeel.app/)
...
:::{.div .portfolio}
[![[Honda: Scenic Audio]{.bold}](posts/imgs/portfolio/scenicaudio.png){fig-alt="logo for project that says 'scenic audio' with wavy lines behind it. Honda logo above scenic audio logo"}](https://www.scenicaudio.app/experience)

* Use realtime data and AI to describe road trip scenery and attractions for those with low- or no-vision
* Try the non-driving version [here](https://www.scenicaudio.app/experience){.portfolio}
* Featured in [BBC TopGear](https://www.topgear.com/car-news/tech/honda-creates-app-help-blind-occupants-see-out-car-window){.portfolio}
:::
