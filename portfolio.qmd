...
:::{.div .portfolio}
[![[Honda: Scenic Audio]{.bold}](posts/imgs/portfolio/scenicaudio.png){fig-alt="logo for project that says 'scenic audio' with wavy lines behind it. Honda logo above scenic audio logo"}](https://www.scenicaudio.info/)
